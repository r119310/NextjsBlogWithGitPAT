...
export default function Header() {
  return <header className="transition-colors sticky top-0 z-10 bg-gray-100 px-4 dark:bg-slate-900">
    <nav className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-3 items-center h-14">
      <div className="flex flex-row">
        <div>
          <Link className="hover:underline" href="/">
            <div className="flex gap-1.5">
              <svg className="transition-colors size-7 dark:fill-slate-400" id="_layer1" data-name="layer1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
